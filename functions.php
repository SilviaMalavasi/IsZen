...
add_filter('block_categories_all', 'iszen_block_categories');
...
add_action('acf/validate_save_post', 'iszen_validate_save_post', 5);
function iszen_validate_save_post()
{
    $acf = false;
...
/* ACF WYSIWIG remove p */

add_action('acf/init', 'iszen_acf_wysiwyg_remove_wpautop');

function iszen_acf_wysiwyg_remove_wpautop()
{
    // remove p tags //
